...
| 004 | transaction-filters | standard | Given a list of transactions, when we filter by text search, category, type, and sort by date or amount, then the table updates dynamically and correctly | PENDING | frontend, filter, search, sort |
